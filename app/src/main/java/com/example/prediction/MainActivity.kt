...
import com.example.prediction.ml.FlowerModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Redirect user to google search for the flower
    ...
    private fun downloadImage(mBitmap: Bitmap):Uri? {
        val contentValues = ContentValues().apply {
            put(MediaStore.Images.Media.DISPLAY_NAME,"Flower_Images" + System.currentTimeMillis()/1000)
    ...
    private fun outputGenerator(bitmap: Bitmap) {
        ...
        if (outputs.isNotEmpty()) {
            ...
            if (highProbabilityOutput.score >= THRESHOLD) {
